...
class FamilyScheduleBot:
    ...
    def __init__(self):
        ...
        # Расписание на 15.09.2026. Плавание в воскресенье с плавающим
        # временем: варианты 13:30, 15:00, 16:30, 19:30 — жёсткое время
        # здесь врало бы, оно меняется от недели к неделе.
        self.kids_schedule = {
            'понедельник': [
                {'child': 'Марта', 'activity': 'Фехтование', 'time': '15:00-16:30'},
                {'child': 'Аркаша', 'activity': 'Фехтование', 'time': '16:15-18:00'},
                {'child': 'Марта', 'activity': 'Английский', 'time': '18:00-18:45'}
            ],
            'вторник': [
            ...
            'среда': [
                {'child': 'Марта', 'activity': 'Фехтование', 'time': '15:00-16:30'},
                {'child': 'Аркаша', 'activity': 'Фехтование', 'time': '16:15-18:00'},
                {'child': 'Марта', 'activity': 'Английский', 'time': '17:00-17:45'},
                {'child': 'Аркаша', 'activity': 'Математика', 'time': '19:00-20:00'}
            ],
            'четверг': [
                {'child': 'Марта', 'activity': 'Шахматы', 'time': '14:40-16:20'},
                {'child': 'Аркаша', 'activity': 'Футбол', 'time': '17:00-18:00'}
            ],
            'пятница': [
                {'child': 'Марта', 'activity': 'Фехтование', 'time': '15:00-16:30'},
            ...
            'суббота': [
                {'child': 'Марта', 'activity': 'Шахматы', 'time': '13:50-15:30'},
                {'child': 'Марта', 'activity': 'Фехтование', 'time': '15:00-16:30'},
                {'child': 'Аркаша', 'activity': 'Фехтование', 'time': '16:15-18:00'}
            ],
            'воскресенье': [
                {'child': 'Марта', 'activity': 'Фехтование', 'time': '10:30-12:00'},
                {'child': 'Аркаша', 'activity': 'Фехтование', 'time': '12:00-14:00'},
                {'child': 'Марта', 'activity': 'Плавание (или 15:00, 16:30, 19:30)', 'time': '13:30'}
            ]
        }
