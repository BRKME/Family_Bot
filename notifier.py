...
class FamilyScheduleBot:
    ...
    def __init__(self):
        ...
        self.wisdoms = [
            ...
            "Не трать время на рассуждения о том, каким должен быть хороший человек. Будь им. — Марк Аврелий",
            ...
            "Трудно найти врага опаснее, чем человек, которому ты помог. — Сенека",
            "Жизнь долга, если знаешь, как её использовать. — Сенека",
