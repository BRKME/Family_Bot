...
class FamilyScheduleBot:
    ...
    def __init__(self):
        ...
        self.wisdoms = [
            "Пусть сегодняшний день принесёт много улыбок и приятных моментов",
            "Хорошее настроение — лучший старт для любого дня",
            "Пусть этот день будет наполнен теплом и радостью",
            "Сегодня отличный день, чтобы быть счастливым",
            "Пусть каждый момент сегодня будет особенным",
            "Доброе утро! Пусть день принесёт что-то хорошее",
            "Пусть сегодня всё получится легко и с удовольствием",
            "Желаю тебе сегодня больше поводов для улыбки",
            "Пусть этот день будет добрым и светлым",
            "Сегодня — прекрасный день для маленьких радостей",
            "Пусть всё задуманное сегодня сбудется",
            "Желаю тебе сегодня встретить что-то приятное",
            "Пусть день пройдёт в гармонии и спокойствии",
            "Сегодня всё будет хорошо, просто поверь в это",
            "Пусть этот день подарит тебе вдохновение",
            "Желаю тебе сегодня найти повод для радости",
            "Пусть каждый час сегодня принесёт что-то доброе",
            "Сегодня — день для новых открытий и улыбок",
            "Пусть всё сегодня складывается в твою пользу",
            "Желаю тебе сегодня чувствовать себя на высоте",
            "Пусть этот день будет полон приятных сюрпризов",
            "Сегодня — отличный день, чтобы насладиться жизнью",
            "Пусть всё получится так, как ты хочешь",
            "Желаю тебе сегодня больше энергии и меньше забот",
            "Пусть день принесёт тебе покой и радость",
            "Сегодня всё будет именно так, как нужно",
            "Пусть этот день станет началом чего-то хорошего",
            "Желаю тебе сегодня лёгкости во всём",
            "Пусть каждая минута сегодня будет приятной",
            "Сегодня — день для хороших новостей",
            "Пусть всё сегодня идёт своим чередом и легко",
            "Желаю тебе сегодня встретить добрых людей",
            "Пусть этот день будет наполнен смыслом",
            "Сегодня — прекрасное время для счастья",
            "Пусть всё сегодня получается с первого раза",
            "Желаю тебе сегодня сил и хорошего настроения",
            "Пусть день подарит тебе тепло и уют",
            "Сегодня всё к лучшему, так и знай",
            "Пусть этот день будет щедрым на радость",
            "Желаю тебе сегодня найти время для себя",
            "Пусть всё сегодня складывается удачно",
            "Сегодня — день для добрых дел и светлых мыслей",
            "Пусть каждый шаг сегодня будет лёгким",
            "Желаю тебе сегодня чувствовать себя прекрасно",
            "Пусть этот день принесёт мир в душе",
            "Сегодня всё получится, главное — начать",
            "Пусть день будет добрым к тебе и близким",
            "Желаю тебе сегодня позитивных эмоций",
            "Пусть всё сегодня радует и вдохновляет",
            "Сегодня — отличный день для улыбок",
            "Пусть этот день будет полон света",
            "Желаю тебе сегодня встретить что-то красивое",
            "Пусть всё сегодня идёт по плану и даже лучше",
            "Сегодня — день для приятных открытий",
            "Пусть каждое мгновение сегодня будет ценным",
            "Желаю тебе сегодня больше тепла и меньше стресса",
            "Пусть этот день будет гармоничным",
            "Сегодня всё сложится как надо",
            "Пусть день принесёт тебе вдохновение и силы",
            "Желаю тебе сегодня радоваться мелочам",
            "Пусть всё сегодня получается легко и приятно",
            "Сегодня — прекрасный день для благодарности",
            "Пусть этот день будет добрым началом",
            "Желаю тебе сегодня ясности и спокойствия",
            "Пусть всё сегодня приносит удовольствие",
            "Сегодня — день для хороших эмоций",
            "Пусть каждый час сегодня будет продуктивным",
            "Желаю тебе сегодня встретить красоту вокруг",
            "Пусть этот день будет наполнен добротой",
            "Сегодня всё идёт своим чередом и правильно",
            "Пусть день подарит тебе уверенность",
            "Желаю тебе сегодня больше радости",
            "Пусть всё сегодня радует глаз и душу",
            "Сегодня — отличный день для побед",
            "Пусть этот день будет лёгким и приятным",
            "Желаю тебе сегодня найти гармонию",
            "Пусть всё сегодня складывается прекрасно",
            "Сегодня — день для добрых встреч",
            "Пусть каждая минута сегодня будет в радость",
            "Желаю тебе сегодня чувствовать себя любимым",
            "Пусть этот день будет полон смысла",
            "Сегодня всё получится, если захотеть",
            "Пусть день принесёт тебе спокойствие",
            "Желаю тебе сегодня больше поводов для счастья",
            "Пусть всё сегодня идёт легко и радостно",
            "Сегодня — прекрасный день, чтобы улыбнуться",
            "Пусть этот день будет добрым и солнечным",
            "Желаю тебе сегодня тепла и уюта в сердце",
            "Пусть всё сегодня приносит радость",
            "Сегодня — день для хорошего настроения",
